...
require_once("$CFG->dirroot/mod/workbook/locallib.php");
 ...
 * is due to change.
 */
Mock::generate('workbook_portfolio_caller', 'mock_caller');
Mock::generate('portfolio_exporter', 'mock_exporter');

class testWorkbookPortfolioCallers extends portfoliolib_test {
/*
    public static $includecoverage = array('lib/portfoliolib.php', 'mod/workbook/lib.php');
    public $module_type = 'workbook';
    ...
    public function setUp() {
        ...
        generator_generate_workbook($settings);
        ...
        $fields = $DB->get_records('workbook_fields', array('workbookid' => $first_module->id));
        $recordid = workbook_add_record($first_module);
        ...
        $this->caller_single = parent::setup_caller('workbook_portfolio_caller', array('id' => $cm->id, 'record' => $recordid));
        $this->caller = parent::setup_caller('workbook_portfolio_caller', array('id' => $cm->id));
    }

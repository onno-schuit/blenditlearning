...
/**
 * Strings for component 'workbook', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   workbook
...
$string['availabletags_help'] = 'Tags are placeholders in the template, which will be replaced by workbook or other items, such as an edit icon, when entries are edited or viewed.
...
$string['configenablerssfeeds'] = 'This switch will enable the possibility of RSS feeds for all workbooks. You will still need to turn feeds on manually in the settings for each workbook.';
...
$string['csvfailed'] = 'Unable to read the raw workbook from the CSV file';
$string['csvfile'] = 'CSV file';
$string['csvimport'] = 'CSV file import';
$string['csvimport_help'] = 'Entries may be imported via a plain text file with a list of field names as the first line, then the workbook, with one record per line.';
$string['csvwithselecteddelimiter'] = '<acronym title="Comma Separated Values">CSV</acronym> text with selected delimiter:';
$string['workbook:approve'] = 'Approve unapproved entries';
$string['workbook:comment'] = 'Write comments';
$string['workbook:exportallentries'] = 'Export all workbook entries';
$string['workbook:exportentry'] = 'Export a workbook entry';
$string['workbook:exportownentry'] = 'Export own workbook entry';
$string['workbook:managecomments'] = 'Manage comments';
$string['workbook:manageentries'] = 'Manage entries';
$string['workbook:managetemplates'] = 'Manage templates';
$string['workbook:manageuserpresets'] = 'Manage all template presets';
$string['workbook:rate'] = 'Rate entries';
$string['workbook:readentry'] = 'Read entries';
$string['workbook:viewalluserpresets'] = 'View presets from all users';
$string['workbook:viewallratings'] = 'View all raw ratings given by individuals';
$string['workbook:viewanyrating'] = 'View total ratings that anyone received';
$string['workbook:viewentry'] = 'View entries';
$string['workbook:viewrating'] = 'View the total rating you received';
$string['workbook:writeentry'] = 'Write entries';
$string['date'] = 'Date';
...
$string['eentrieslefttoaddtoviewntrieslefttoaddtoview'] = 'You must add {$a->entrieslefttoview} more entry/entries before you can view other participants\' entries.';
$string['entry'] = 'Entry';
...
$string['example'] = 'Workbook module example';
$string['excel'] = 'Excel';
...
$string['fieldmappings_help'] = 'This menu allows you to keep the workbook from the existing workbook. To preserve the workbook in a field, you must map it to a new field, where the workbook will appear. Any field can also be left blank, with no infomation copied into it. Any old field not mapped to a new one will be lost and all it\'s workbook removed.
...
$string['fieldnotmatched'] = 'The following fields in your file are not known in this workbook: {$a}';
...
$string['filtername'] = 'Workbook auto-linking';
...
$string['insufficiententries'] = 'more entries needed to view this workbook';
...
$string['invalidid'] = 'Incorrect workbook ID';
...
$string['mappingwarning'] = 'All old fields not mapped to a new field will be lost and all workbook in that field will be removed.';
...
$string['missingworkbook'] = 'Workbook id or object must be provided to field class';
$string['missingfield'] = 'Programmer error: You must specify field and/or workbook when defining field class.';
$string['modulename'] = 'Workbook';
$string['modulename_help'] = 'The workbook activity module enables participants to create, maintain and search a bank of record entries. The format and structure of these entries can be almost unlimited, including images, files, URLs, numbers and text amongst other things.';
...
$string['newfield_help'] = 'A field allows the input of workbook. Each entry in a workbook activity can have multiple fields of multiple types such as a date field, which allows participants to select a day, month and year from a dropdown list, a picture field, which allows participants to upload an image file, or a checkbox field, which allows participants to select one or more options.
...
$string['nofieldinworkbook'] = 'There are no fields defined for this workbook.';
...
$string['norecords'] = 'No entries in workbook';
...
$string['page-mod-workbook-x'] = 'Any workbook activity module page';
$string['pagesize'] = 'Entries per page';
$string['participants'] = 'Participants';
$string['picture'] = 'Picture';
$string['pleaseaddsome'] = 'Please create some below or <a href="{$a}">choose a predefined set</a> to get started.';
$string['pluginadministration'] = 'Workbook activity administration';
$string['pluginname'] = 'Workbook';
$string['portfolionotfile'] = 'Export to a portfolio rather than a file (csv and leap2a only)';
$string['presetinfo'] = 'Saving as a preset will publish this template. Other users may be able to use it in their workbooks.';
...
Note: If entries are required before viewing, the workbook auto-linking filter should be disabled. This is because the workbook auto-linking filter can\'t determine whether a user has submitted the required number of entries.';
...
$string['subplugintype_workbookfield'] = 'Workbook field type';
$string['subplugintype_workbookfield_plural'] = 'Workbook field types';
$string['subplugintype_workbookpreset'] = 'Preset';
$string['subplugintype_workbookpreset_plural'] = 'Presets';
...
$string['toworkbook'] = 'to this workbook.';
$string['type'] = 'Field type';
$string['undefinedprocessactionmethod'] = 'No action method defined in Workbook_Preset to handle action "{$a}".';
...
* Each record is a series of workbook separated by commas (or other delimiters)
...
$string['uploadrecords_link'] = 'mod/workbook/import';
$string['url'] = 'Url';
...
$string['wrongworkbookid'] = 'Wrong workbook id provided';

...
class workbook_field_latlong extends workbook_field_base {
    var $type = 'latlong';
    ...
    var $linkoutservices = array(
          ...
          "Google Earth" => "@wwwroot@/mod/workbook/field/latlong/kml.php?d=@workbookid@&fieldid=@fieldid@&rid=@recordid@",
          "Geabios" => "http://www.geabios.com/html/services/maps/PublicMap.htm?lat=@lat@&lon=@long@&fov=0.3&title=Moodle%20workbook%20item",
    ...
    function display_add_field($recordid=0) {
        ...
        $str .= '<label for="field_'.$this->field->id.'_0">' . get_string('latitude', 'workbook') . '</label></td><td><input type="text" name="field_'.$this->field->id.'_0" id="field_'.$this->field->id.'_0" value="'.s($lat).'" size="10" />°N</td></tr>';
        $str .= '<tr><td align="right"><label for="field_'.$this->field->id.'_1">' . get_string('longitude', 'workbook') . '</label></td><td><input type="text" name="field_'.$this->field->id.'_1" id="field_'.$this->field->id.'_1" value="'.s($long).'" size="10" />°E</td></tr>';
        $str .= '</table>';
        $str .= '</fieldset>';
        $str .= '</div>';
        return $str;

...
class workbook_field_file extends workbook_field_base {
    var $type = 'file';
    ...
    function display_add_field($recordid=0) {
        ...
        // editing an existing workbook entry
        if ($recordid){
        ...
        $module = array('name'=>'workbook_filepicker', 'fullpath'=>'/mod/workbook/workbook.js', 'requires'=>array('core_filepicker'));
        $PAGE->requires->js_init_call('M.workbook_filepicker.init', array($fp->options), true, $module);

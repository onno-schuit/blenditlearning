...
class workbook_field_multimenu extends workbook_field_base {
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content  = $this->format_workbook_field_multimenu_content($value);
    ...
    function format_workbook_field_multimenu_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);

...
class workbook_field_date extends workbook_field_base {
    ...
    function display_add_field($recordid=0) {
        ...
        if ($recordid) {
            $content = (int)$DB->get_field('workbook_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid));
        } else {
            $content = time();
        }
    ...
    function display_browse_field($recordid, $template) {
        ...
        if ($content = $DB->get_field('workbook_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid))) {

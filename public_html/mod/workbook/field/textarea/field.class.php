...
class workbook_field_textarea extends workbook_field_base {
    ...
    function display_add_field($recordid=0) {
        ...
        if ($recordid && $content = $DB->get_record('workbook_content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid))){
        ...
        // Hack by Onno Schuit - always use plain format as per customer's request
        $format = FORMAT_PLAIN;
